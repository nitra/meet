...
// @ts-expect-error - tinykeys has no TypeScript types
...
export const useDebugMode = ({ logLevel }: { logLevel?: LogLevel }) => {
  ...
  React.useEffect(() => {
    ...
    // @ts-expect-error - debug: expose room on window for devtools
    window.__lk_room = room;

    return () => {
      // @ts-expect-error - debug: clear room reference on cleanup
